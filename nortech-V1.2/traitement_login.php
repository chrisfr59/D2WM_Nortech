...
}else if($mp_user=='nortech'){
        echo"<script type='text/javascript'>document.location.replace('mPasse.php');
             alert('Première connexion : Veuillez modifier votre mot de passe');</script>";
    }    
else{
...
$sql="SELECT e.nom,e.prenom FROM employe e, utilisateur i WHERE i.noEmp=e.noEmp AND i.identifiant='$id'";
